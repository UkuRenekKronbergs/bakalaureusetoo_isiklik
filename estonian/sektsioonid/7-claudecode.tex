...
Käesolev peatükk kirjeldab Claude Code'i kui agentset AI tööriista, mis võimaldab terviklike akadeemiliste tööde genereerimist otse arenduskeskkonnas. Peatükk annab ülevaate tööriista arhitektuurist, töövoogudest ning esitab praktilised soovitused lõputöö genereerimiseks. Lisaks esitatakse juhtumiuuring Opus 4.6 mudeliga, milles kasutati Anthropicu teist agentset tööriista Cowork, mis on Claude Code'iga sarnase ülesehituse ja töövoogudega, kuid neist eraldiseisev toode.
...
\begin{itemize}
    ...
    \item \textbf{Ole kursis enda tööga.} AI on abivahend, mitte autor. Üliõpilane peab iga genereeritud lõigu sisuliselt üle vaatama ja vajadusel ümber kirjutama.
...
\subsection{Alternatiivne Anthropicu tööriist: Cowork} \label{subsec:cowork}

Lisaks Claude Code'ile pakub Anthropic teist agentset tööriista nimega Cowork. Cowork on Claude Code'ist eraldiseisev toode, kuid pakub funktsionaalselt sarnast võimekust: iseseisev failisüsteemi juurdepääs, \LaTeX{} kompileerimine, viidete haldus ning projekti struktureerimine. Käesoleva uurimuse eksperimendis kasutati Cowork'i Sonnet 4.6 ja Opus 4.6 mudelitega (Claude Code'i aga ei kasutatud), kuna Cowork pakkus mugavama integratsiooni olemasoleva projektistruktuuriga. Oluline on tööriistu mitte samastada -- kuigi nad on mõlemad Anthropicu tooted ja kasutavad Claude mudeliperekonda, on tegemist eri rakendustega. Järgmine alamlõik esitab Opus 4.6 ja Cowork'i juhtumiuuringu.
...
\subsection{Juhtumiuuring: Paroolihalduri lõputöö genereerimine Opus 4.6-ga Cowork'i kaudu} \label{subsec:cowork-juhtumiuuring}
