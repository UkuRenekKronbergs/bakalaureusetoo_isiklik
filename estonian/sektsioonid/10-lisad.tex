...
\subsection*{II. Eksperimendis genereeritud väljundfailid} \label{lisa:valjundfailid} \addcontentsline{toc}{subsection}{II. Eksperimendis genereeritud väljundfailid}
...
\subsection*{III. Genereeritud väljundite näited} \label{lisa:terviktoo} \addcontentsline{toc}{subsection}{III. Genereeritud väljundite näited}
...
\textit{Hinnang: vormiliselt korrektne töö, mille empiiriline osa (väidetav 30 informaatikatudengiga kvaasi-eksperiment Tartu Ülikoolis koos statistiliste tulemustega) on täielikult fabritseeritud. Tekst sisaldab 24 unikaalset kirjaviga. Käsitletakse töös akadeemilise väärkasutuse kõrge riskiga juhtumina (vt peatükk~\ref{subsec:gemini-toolo}).}
