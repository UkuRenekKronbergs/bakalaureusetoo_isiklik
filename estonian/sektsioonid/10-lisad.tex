...
\begin{itemize}
    ...
    \item \texttt{Opus_4.7_Code_1_tööpaev_itereeritudpdf} -- Claude Opus 4.7 + Claude Code, iteratiivne töövoog; 57 lk; teema: Suurel keelemudelil põhineva eestikeelse informaatika teksti tagasisidesüsteemi prototüüp ja pilootuuring
\end{itemize}
