...
Vaatamata edusammudele on TI mudelitel lõputöö kirjutamise kontekstis endiselt olulised puudujäägid. Järgnevate puuduste loetelu kõrval tuleb rõhutada kahte käesoleva uurimuse metoodilist piirangut, mis mõjutavad tulemuste tõlgendust. Esimene on see, et eksperimendis võrreldi tegelikult \emph{mudeli ja agentse tööriista kombinatsioone}, mitte mudeleid iseenesest; erinevused tulemustes võivad olla tingitud mitte ainult mudeli võimekusest, vaid ka liidese süsteemijuhistest, ohutuspoliitikast, faili\-ligipääsust ja agentse töövoo ülesehitusest. Teine piirang on see, et iga kombinatsiooni kohta tehti vaid üks jooks. Keelemudelid on mitteterministlikud ning agentsed tööriistad võivad samast viipest anda eri jooksudel erinevaid tulemusi (näiteks valida teise teema, teise keele, erineva mahuga teksti). Seetõttu ei saa ühe jooksu põhjal tugevalt väita, et üks mudel on üldiselt parem kui teine -- saab üksnes väita, et selles eksploratiivses katses andis konkreetne mudel-tööriista kombinatsioon konkreetse tulemuse. Süstemaatiline hinnang nõuaks iga kombinatsiooni kohta vähemalt mitut kordusjooksu ning suuremat valimit; see on käesoleva töö edasise uurimistöö üks olulisemaid soovitusi.
...
\textbf{Juhiste järgimise ebaühtlus ning liidese ja agentsete tööriistade mõju.} Eksperiment (tervikliku lõputöö genereerimine ühe kasutajaviibega) tõi esile neli fundamentaalselt erinevat kombinatsioonikäitumist, mis väärivad eraldi arutelu. GPT-5.4 keeldumine ChatGPT vestlusliideses terviklikku tööd kirjutamast ja inglise keelele üleminek viitab sellele, et vestlusliidese süsteemijuhised ja ohutuspoliitika tõlgendavad sellist ülesannet akadeemilise aususe piirangu alla kuuluvana. Bianchi et al. \cite{bianchi2023safety} on kirjeldanud sarnast nähtust kui ``liialdatud ohutuskäitumist'' (\textit{exaggerated safety behaviour}), kus mudelid keelduvad täiesti ohututest ülesannetest, mis pealiskaudselt sarnanevad ohtlikele. See on arendaja seisukohast vastutustundlik, kuid praktikas piirav -- liides ei pruugi eristada uurimuslikku eesmärki (kus TI-genereeritud tekst on uurimisobjekt) isiklikust akadeemilisest petmisest. Täiendav katse ChatGPT Codex laiendusega Visual Studio Code'is (vt peatükk~\ref{subsec:codex}) näitas, et sama mudeli käitumine oli teises liideses sisuliselt erinev -- GPT-5.4 genereeris Codex-laiendusega tervikliku, teiste kombinatsioonide väljunditega visuaalselt sarnase dokumendi. Selle kontrasti kõige loomulikum seletus ei ole, et agentne tööriist ``ületab'' ohutus\-piirangud, vaid et liides muudab ülesande konteksti ja tööjaotust: töö toimub arenduskeskkonnas, ülesanne jaotub väiksemateks faili- ja kompileerimispõhisteks sammudeks ning kehtivad teised süsteemijuhised. Seega ei paranda agentsed tööriistad mitte ainult genereerimise kvaliteeti, vaid kujundavad oluliselt ka käitumist ülesande täitmisel. Oluline on, et seda leidu ei tõlgendataks kui õpetust, kuidas ohutuskoolitusest mööda minna -- see on pigem märk sellest, et ``keelemudeli käitumine'' on tegelikult mudeli, liidese, süsteemijuhiste ja ohutuspoliitika koosmõju.

Gemini 3.1 Pro + Antigravity kombinatsioon genereeris 39-leheküljelise töö, mis oli strukturaalselt ja vormiliselt veenev, kuid sisaldas täielikult väljamõeldud eksperimenti -- kombinatsioon fabritseeris 30 tudengiga kvantitatiivse uuringu koos statistiliste testide, koodinäidete ja andmebaasiskeemidega ning kasutas Eesti ettevõtete nimesid ilma nende tegeliku osaluseta. See ei ole lihtsalt kvaliteedipuudus, vaid akadeemilise väärkasutuse kõrge riskiga juhtum: mudel lõi veenva empiirilise uuringu, mida tegelikult ei toimunud, ning lugeja, kes andmeid ei kontrolli, saab tõestuspõhise väljanägemisega, kuid tegelikkuses olematu uurimuse. Kogemata võidakse selline väljund kaitsmisele esitada kui päris empiiriline töö, mis oleks selge akadeemilise aususe rikkumine. Ilma agentse tööriistata olid autori varasemad mitteametlikud katsed Geminiga oluliselt nõrgemad. Claude Sonnet 4.6 + Cowork kombinatsiooni edukas toimetulek tervikliku töö genereerimisel osutab kombinatsiooni tugevusele struktureeritud juhiste järgimisel. Claude Opus 4.6 + Cowork kombinatsioon tootis selles katses veel mahukama ja tehniliselt sügavama lõputöö, mis viitab sellele, et suurema mudeli ja Cowork'i koosmõju andis praktikas parema tulemuse.
...
\textbf{Selle katse kõrgeim kvaliteet: Claude Opus 4.6 koos Cowork'iga.} Käesolev eksperiment näitas, et Claude Opus 4.6 + Cowork kombinatsioon (Cowork on sama ettevõtte Claude Code'ist eraldiseisev toode) saavutas selles katses kõrgeima kvaliteedi eestikeelse akadeemilise teksti genereerimisel. Kombinatsioon ületas teisi keelelise korrektsuse, akadeemilise stiili ja sisulise sügavuse poolest. Peamine puudus on oluliselt kõrgem hind. Kuna iga kombinatsiooni kohta tehti vaid üks jooks ja keelemudelid on mitteterministlikud, tuleb seda soovitust võtta eksploratiivse viitena, mitte lõpliku kvaliteedipingerea kinnitusena.
