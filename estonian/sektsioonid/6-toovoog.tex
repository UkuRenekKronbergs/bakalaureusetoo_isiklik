...
Lisaks Claude Code'ile kasutati töö kirjutamise ja hilisema kontrollimise käigus Visual Studio Code'i keskkonnas OpenAI ChatGPT Codex laiendust \cite{openai2025codex}. Codexiga kasutati GPT-5.5 mudelit, peamiselt kirjavigade otsimiseks ja sõnastuse paremaks saamisel. Töö hilisemas toimetamisfaasis kasutati ka Claude Opus 4.7 mudelit \cite{anthropic2026opus47} samaks otstarbeks.

Täiendavalt kasutati järgmisi abivahendeid: Visual Studio Code'i töö\-keskkonda, Git'i ja GitHubi versioonihalduseks, TeX Live'i koos \texttt{latexmk}, \texttt{lualatex} ja \texttt{biber} tööriistadega \LaTeX{} kompileerimiseks, töö algfaasis Overleafi, Zotero ekspordikirjeid BibTeX-kirjete koostamisel.
...
\begin{enumerate}
    ...
    \item \textbf{Konkreetsed parandusepalved TI-le.} Autor palus agentsel TI tööriistal teha konkreetseid, kitsalt piiritletud parandusi, liiga pikkade lausete tükeldamine, lauseehituse ühtlustamine, viidete formaadi ja järjekorra kontroll ning \LaTeX{} vormistuse parandamine. Töö hilisemas faasis lasti antud töö üle vaadata mitmel keelemudelil, et leida kirja- ja vormistusvigu.
...
Kogu töö kirjutamise protsessi jooksul hoiti lähtefaile (\LaTeX{} failid, viidete baas ja muud tugifailid) GitHubi repositooriumis. Versioonihalduse kasutamine täitis mitut eesmärki, mis on TI-toetatud kirjutamise kontekstis eriti olulised.
...
\begin{itemize}
    ...
    \item \textbf{Ajainvesteering.} Kuigi TI abil kiirenes vormistus- ja korrektuurifaas märgatavalt, ei vähendanud see sisulise töö (lugemise, mõtlemise, allikate kontrolli, tulemuste analüüsi) mahtu. See jäi autori vastutuda ja moodustas suurema osa tegelikust ajakulust. TI peamine võit oli mehhaanilise töö vähendamine, mitte intellektuaalse töö asendamine.
