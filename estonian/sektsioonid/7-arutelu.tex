...
Soovitatav on järgmine samm-sammuline töövoog:
...
\begin{enumerate}
    ...
    \item \textbf{Lisa viited ise või kontrolli neid põhjalikult.} Ära lase mudelil viiteid ``välja mõelda''. Viidete hallutsineerimise riski vähendamiseks järgi järgmist malli:
    \begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Kompileeri regulaarselt.} Kasuta tööriista või arenduskeskkonna võimalust käivitada käsud \texttt{pdflatex} ja \texttt{biber}, et kontrollida, kas genereeritud \LaTeX{}-kood kompileerub vigadeta.
...
\begin{itemize}
    ...
    \item \textbf{Ära usalda ühe kasutajaviibaga (\textit{single-prompt}) tulemust ilma kriitilise ülevaatamiseta.} Käesoleva uurimuse eksperimendis andis ühe viiba lähenemine mõnel juhul tugeva vormilise tulemuse, kuid sisaldas endiselt hallutsineeritud viiteid ja kontrollimata empiirilisi väiteid (vt peatükk~\ref{eksperimendid}). Märkimisväärselt parema tulemuse saavutamiseks on mõistlik kombineerida ühe viibaga genereerimist iteratiivsete paranduste ja kasutajapoolse ülevaatusega.
