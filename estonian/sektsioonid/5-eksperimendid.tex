...
\subsection{GPT-5.4 (vestlusliides ja Codex): keeldumine ja agentne lahendus} \label{subsec:gpt-toolo}
...
\subsection{Mudelikäitumise üldised järeldused} \label{subsec:mudelikaitumine}
