...
Ilma juhendite ja näideteta genereeritud sissejuhatused erinesid oluliselt kvaliteedilt. Tabelis~\ref{tab:exp1-zero} on esitatud autori antud hinded.
...
Kuna hindamise viis läbi üks hindaja (autor), ei olnud võimalik mõõta hindajatevahelist kooskõla. Subjektiivsuse vähendamiseks vaatas autor iga genereeritud teksti läbi mitmel korral eri aegadel ning lõppskoor kujunes nende iteratsioonide põhjal. Iteratsioonide sisene varieeruvus oli suurim akadeemilise stiili ja praktilise väärtuse kriteeriumides, mis on oma olemuselt teistest kriteeriumidest subjektiivsemad. Ühe hindajaga uurimisülesehituse piiranguid on käsitletud peatükis~\ref{arutelu}.
