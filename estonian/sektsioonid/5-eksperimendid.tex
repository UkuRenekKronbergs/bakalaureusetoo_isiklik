...
\begin{axis}[
    ...
    every node near coord/.append style={font=\scriptsize, text=black, rotate=90, anchor=west},
]
\addplot+[fill=chartBlue, draw=chartBlue!70!black] coordinates {(Gemini,7230) (GPT,9669) (Sonnet,8085) (Opus,10749)};
\end{axis}
\end{tikzpicture}
\caption{Genereeritud tööde mahu võrdlus sõnade koguarvu alusel.}
\label{fig:maht-sonades}
\end{figure}
...
\addplot+[fill=chartBlue, draw=chartBlue!70!black] coordinates {(Gemini,9) (GPT,22) (Sonnet,23) (Opus,35)};
\addplot+[fill=chartGreen, draw=chartGreen!70!black] coordinates {(Gemini,13) (GPT,28) (Sonnet,54) (Opus,45)};
\legend{Unikaalsed allikad, Tekstisisesed viited}
\end{axis}
\end{tikzpicture}
\caption{Genereeritud tööde viidete hulga võrdlus.}
\label{fig:viidete-vordlus}
\end{figure}
...
\begin{axis}[
    thesisbar,
    ylabel={Anglitsisme lehekülje kohta},
    ymax=0.8,
    bar width=18pt,
    nodes near coords={\pgfmathprintnumber[fixed,precision=2,use comma]{\pgfplotspointmeta}},
    every node near coord/.append style={font=\scriptsize, text=black},
]
\addplot+[fill=chartOrange, draw=chartOrange!70!black] coordinates {(Gemini,0.72) (GPT,0.32) (Sonnet,0.15) (Opus,0.46)};
\end{axis}
\end{tikzpicture}
\caption{Anglitsismide tihedus genereeritud töödes.}
\label{fig:anglitsismide-tihedus}
\end{figure}
